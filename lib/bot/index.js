...
var Bot = function (_EventEmitter) {
  ...
  */
	function Bot(authorization, config) {
		...
		_this.exportFunctions = ['getVoiceConnection', 'permissionDenied', 'errorOccurred', 'createModel', 'getUserFromMention'];
  ...
  */
	...
	_createClass(Bot, [{
		...
		value: function start() {
			...
			_mongorito2.default.connect(this.dbUri).then(function (db) {
				...
				_this2.Commander = _this2.createModel('_bot-commander');
				...
				// Set up body parser.
				_this2.express.use(_bodyParser2.default.json({ limit: '50mb' }));
				_this2.express.use(_bodyParser2.default.urlencoded({ extended: true, limit: '50mb' }));
   ...
   */
		...
		key: 'fixCommandsLists',
		value: regeneratorRuntime.mark(function fixCommandsLists() {
			var _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, server, entry, savedCommands, commands, command;

			return regeneratorRuntime.wrap(function fixCommandsLists$(_context3) {
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							_context3.prev = 3;
							_iterator2 = this.client.servers[Symbol.iterator]();
						...
						case 5:
							...
							server = _step2.value;
							_context3.next = 9;
							return this.EnabledCommands.getEntry(server.id, this.enabledCommands);

						case 9:
							entry = _context3.sent;
							savedCommands = entry.val();
			...
			}, fixCommandsLists, this, [[3, 21, 25, 33], [26,, 28, 32]]);
		})
					...
					while (1) {
						switch (_context5.prev = _context5.next) {
							case 0:
								...
								_context5.t0 = regeneratorRuntime.keys(this.plugins);
   ...
   */
		...
		value: regeneratorRuntime.mark(function loadCommandCache() {
			var _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _plugin, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, command;

			return regeneratorRuntime.wrap(function loadCommandCache$(_context6) {
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							...
							_context6.prev = 5;
							_iterator3 = this.plugins[Symbol.iterator]();
						...
						case 7:
							...
							for (_iterator4 = _plugin.plugin.commands[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
			...
			}, loadCommandCache, this, [[5, 33, 37, 45], [12, 16, 20, 28], [21,, 23, 27], [38,, 40, 44]]);
		})
					...
					while (1) {
						switch (_context7.prev = _context7.next) {
							...
							case 2:
								...
								return _context7.abrupt('return', this.client.sendMessage(msg, 'pong'));
   ...
   */
		...
		value: regeneratorRuntime.mark(function getData(server) {
			var roles, textChannels;
			return regeneratorRuntime.wrap(function getData$(_context8) {
				while (1) {
					switch (_context8.prev = _context8.next) {
						case 0:
							// Get the roles.
							roles = this.client.servers.get('id', server).roles.map(function (role) {
								return {
									id: role.id,
									name: role.name,
							...
							textChannels = this.client.servers.get('id', server).channels.filter(function (channel) {
							...
							_context8.t0 = this.client.servers.get('id', server).name;
							_context8.t1 = roles;
							_context8.t2 = textChannels;
							_context8.next = 7;
							return this.Prefix.getEntry(server, this.config.COMMAND_PREFIX);

						case 7:
							_context8.t3 = _context8.sent.val();
							_context8.next = 10;
							return this.Commander.getEntry(server, '');

						case 10:
							_context8.t4 = _context8.sent.val();
							_context8.next = 13;
							return this.EnabledCommands.getEntry(server, this.enabledCommands);

						case 13:
							_context8.t5 = _context8.sent.val();
							return _context8.abrupt('return', {
								'name': _context8.t0,
								'roles': _context8.t1,
								'textChannels': _context8.t2,
								'prefix': _context8.t3,
								'commander': _context8.t4,
								'commands': _context8.t5
							});
   ...
   */
		...
		value: regeneratorRuntime.mark(function saveData(server, data) {
			var entry, _entry, _entry2;

			return regeneratorRuntime.wrap(function saveData$(_context9) {
				while (1) {
					switch (_context9.prev = _context9.next) {
						...
						case 9:
							_entry = _context9.sent;

							_entry.val(data.commander);
							_context9.next = 13;
							return _entry.save();
						...
						case 15:
							_entry2 = _context9.sent;

							_entry2.val(data.commands);
							_context9.next = 19;
							return _entry2.save();
   ...
   */
		...
		value: regeneratorRuntime.mark(function handleCommand(msg, command, suffix) {
			var commands;
			return regeneratorRuntime.wrap(function handleCommand$(_context10) {
				while (1) {
   ...
   */
      ...
      */
					...
					value: regeneratorRuntime.mark(function getEntry(server, def) {
						var entries;
						return regeneratorRuntime.wrap(function getEntry$(_context11) {
							while (1) {
								switch (_context11.prev = _context11.next) {
									...
									case 2:
										...
										return _context11.abrupt('return', entries[0]);

									case 7:
										return _context11.abrupt('return', new this({
											'server': server,
											'value': def
										}));
   ...
   */
		...
		key: 'getUserFromMention',
		value: function getUserFromMention(mention) {
			// Get the id from the mention.
			var matches = /([0-9]+)/.exec(mention);
