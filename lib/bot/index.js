  ...
  */
   ...
   */
		...
		value: regeneratorRuntime.mark(function loadCommandCache() {
			var _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _plugin, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, command;

			return regeneratorRuntime.wrap(function loadCommandCache$(_context5) {
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							...
							_context5.prev = 5;
							_iterator2 = this.plugins[Symbol.iterator]();
						...
						case 7:
							...
							for (_iterator3 = _plugin.plugin.commands[Symbol.iterator](); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
					...
					while (1) {
						switch (_context6.prev = _context6.next) {
							...
							case 2:
								...
								return _context6.abrupt('return', this.client.sendMessage(msg, 'pong'));
   ...
   */
		...
		value: regeneratorRuntime.mark(function getData(server) {
			var entry, savedCommands, commands, command;
			return regeneratorRuntime.wrap(function getData$(_context7) {
				while (1) {
					switch (_context7.prev = _context7.next) {
						...
						case 9:
							_context7.t0 = this.client.servers.get('id', server).name;
							_context7.next = 12;
							return this.Prefix.getEntry(server, this.config.COMMAND_PREFIX);

						case 12:
							_context7.t1 = _context7.sent.val();
							_context7.t2 = commands;
							return _context7.abrupt('return', {
								'name': _context7.t0,
								'prefix': _context7.t1,
								'commands': _context7.t2
							});
   ...
   */
		...
		value: regeneratorRuntime.mark(function saveData(server, data) {
			...
			return regeneratorRuntime.wrap(function saveData$(_context8) {
				while (1) {
   ...
   */
		...
		value: regeneratorRuntime.mark(function handleCommand(msg, command, suffix) {
			var commands;
			return regeneratorRuntime.wrap(function handleCommand$(_context9) {
				while (1) {
   ...
   */
      ...
      */
					...
					value: regeneratorRuntime.mark(function getEntry(server, def) {
						var entries;
						return regeneratorRuntime.wrap(function getEntry$(_context10) {
							while (1) {
								switch (_context10.prev = _context10.next) {
									...
									case 2:
										...
										return _context10.abrupt('return', entries[0]);

									case 7:
										return _context10.abrupt('return', new this({
											'server': server,
											'value': def
										}));
