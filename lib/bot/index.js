	...
	_createClass(Bot, [{
		...
		value: function start() {
			...
			_mongorito2.default.connect(this.dbUri).then(function (db) {
				...
				// Create models.
				_this2.Prefix = _this2.createModel('command-prefix');
			...
			return regeneratorRuntime.wrap(function getData$(_context6) {
				while (1) {
					switch (_context6.prev = _context6.next) {
						case 0:
							_context6.t0 = this.client.servers.get(server).name;
							_context6.next = 3;
   ...
   */
      ...
      */
					...
					value: regeneratorRuntime.mark(function getEntry(server, def) {
						var entries;
						return regeneratorRuntime.wrap(function getEntry$(_context8) {
							while (1) {
								switch (_context8.prev = _context8.next) {
									...
									case 2:
										...
										return _context8.abrupt('return', entries[0]);

									case 7:
										return _context8.abrupt('return', new this({
											'server': server,
											'value': def
										}));
