  ...
  */
   ...
   */
		...
		value: regeneratorRuntime.mark(function fixCommandsLists() {
			var _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, server, entry, savedCommands, _commands, command;
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						...
						case 9:
							...
							_commands = this.enabledCommands;

							// Make corrections.

							for (command in savedCommands) {
								if (_commands[command] !== undefined && !savedCommands[command]) _commands[command] = false;
							}
				...
				while (1) {
					switch (_context8.prev = _context8.next) {
						...
						case 3:
							...
							_context8.t2 = commands;
							return _context8.abrupt('return', {
								'name': _context8.t0,
								'prefix': _context8.t1,
								'commands': _context8.t2
							});
