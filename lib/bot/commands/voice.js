...
exports.Leave = exports.Join = undefined;
...
var Join = exports.Join = function (_Command) {
	...
	_createClass(Join, [{
		...
		value: function authorize(msg, suffix, next) {
			...
			_command.Util.checkRole(msg.server, msg.author, this.config.commander); // Must be a commander.
			next(allowed);
		}
	}, {
		key: 'process',
...
var Leave = exports.Leave = function (_Command2) {
