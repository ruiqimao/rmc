...
exports.Slap = exports.Pet = undefined;
...
var Pet = exports.Pet = function (_Command) {
	...
	_createClass(Pet, [{
		...
		value: function process(msg, suffix) {
			...
			this.client.sendMessage(msg, '*~kya~*, I\'ve been petted ' + countString + '.', function () {
				...
				if (Math.random() > 0.5) {
					// Heart!
					_this2.client.sendMessage(msg, ':heart:');
				} else {
					// B-baka!
					_this2.client.sendMessage(msg, 'B-baka! It\'s not like I wanted you to pet me or anything...');
				}
			});
		}
	}, {
...
var Slap = exports.Slap = function (_Command2) {
