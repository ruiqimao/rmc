					...
					if (_this4.state.loaded) {
						return _react2.default.createElement(
							...
							_react2.default.createElement(Header, {
								data: data,
								saving: _this4.state.saving,
								onSave: _this4.save
							}),
							_react2.default.createElement(_bot2.default, { data: data }),
							data.about && _react2.default.createElement(_about2.default, { data: data })
						);
					}
				}()
			);
	...
	_createClass(Header, [{
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: _dashboard2.default.headerRight },
					_react2.default.createElement(
						_button2.default,
						{
