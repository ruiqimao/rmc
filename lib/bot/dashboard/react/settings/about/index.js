...
var AboutSettings = function (_React$Component) {
	_inherits(AboutSettings, _React$Component);

	function AboutSettings(props) {
		_classCallCheck(this, AboutSettings);

		// Bind all listeners.
		var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AboutSettings).call(this, props));
