				...
				while (1) {
					switch (_context2.prev = _context2.next) {
						case 0:
							...
							return _context2.abrupt('return', allowed);
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							return _context3.abrupt('return', this.client.reply(msg, 'Give me a number of messages to delete. A NUMBER, dumbass.'));
						...
						case 10:
							_context3.next = 12;
							return this.client.getChannelLogs(msg, number);
