				...
				while (1) {
					switch (_context4.prev = _context4.next) {
						case 0:
							...
							return _context4.abrupt('return', this.client.reply(msg, 'Overload! I can\'t queue that many songs. Feed me more RAM.'));
						...
						case 4:
							...
							return _context4.abrupt('return', this.client.reply(msg, 'Give me a video, dumbass.'));
...
var Skip = function (_Command2) {
	...
	_createClass(Skip, [{
			...
			return regeneratorRuntime.wrap(function authorize$(_context5) {
				while (1) {
					switch (_context5.prev = _context5.next) {
						case 0:
							return _context5.abrupt('return', this.plugin.authorize(this, msg));
		...
		value: regeneratorRuntime.mark(function process(msg, suffix) {
			...
			return regeneratorRuntime.wrap(function process$(_context6) {
				while (1) {
