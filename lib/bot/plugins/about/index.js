...
var _source = require('./commands/source');
			...
			return regeneratorRuntime.wrap(function init$(_context) {
				while (1) {
					switch (_context.prev = _context.next) {
						case 0:
							this.addCommand('about', _about2.default);
							this.addCommand('source', _source2.default);
							this.addCommand('uptime', _uptime2.default);
