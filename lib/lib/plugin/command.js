...
var Command = function () {
  ...
  */
	function Command(plugin) {
		...
		try {
			for (var _iterator = plugin.exportFunctions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
					...
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 2:
								...
								return _context.abrupt('return', (0, _co2.default)(this.process.bind(this), msg, suffix).catch(function (err) {
									console.error(err);
