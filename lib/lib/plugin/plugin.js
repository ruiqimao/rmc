...
var Plugin = function () {
  ...
  */
	function Plugin(bot) {
		...
		// Set the constants.
		this.PERMISSION_DENIED_RESPONSES = ['I don\'t recognize your authority.', 'No.', 'Fuck off.', 'No, fuck you.', 'Who do you think you are, telling me what to do?', 'Don\'t tell me what to do.', 'HAHAHA no.', 'Ehhh...', 'Nah.', 'Yeah no.', 'Screw that.', 'Beep boop, permission denied, fucker!'];
	}
